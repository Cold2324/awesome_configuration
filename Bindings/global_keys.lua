...
local Volume_Control = {
    Key({}, "XF86AudioRaiseVolume", function () awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ +5%") end, {description = "raise volume"}),
    Key({}, "XF86AudioLowerVolume", function () awful.spawn("pactl set-sink-volume @DEFAULT_SINK@ -5%") end, {description = "lower volume"}),
    Key({}, "XF86AudioMute", function () awful.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle") end, {description = "mute volume"}),
}
...
globalkeys = gears.table.join(
    ...
    Key({modkey, "Shift"}, "s", function () awful.spawn("rofi -show drun") end, {description = "open rofi launcher", group = "launcher"}),
